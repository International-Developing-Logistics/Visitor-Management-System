...
/** Builds a facility-prefixed path, e.g. facilityPath(FACILITIES.idl, "/gate") -> "/idl/gate". */
export function facilityPath(facility, path) {
  return facility.key === DEFAULT_FACILITY ? path : `/${facility.key}${path}`;
}
